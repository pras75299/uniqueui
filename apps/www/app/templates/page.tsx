...
const TEMPLATES: Template[] = [
  {
    ...
    description:
      "A full-featured SaaS landing with hero, features bento, pricing cards, and a testimonials marquee. Motion-rich and conversion-optimized.",
    niche: "SaaS",
    difficulty: "Pro",
    status: "coming-soon",
    components: ["Glow Hero Section", "Bento Grid", "Spotlight Card", "Infinite Marquee", "Animated Tabs"],
