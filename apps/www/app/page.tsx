  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "pointer-events-none fixed inset-0 z-0 flex-none items-center px-5 py-24",
            isDark
        ...
        {/* Hero */}
        <section className="relative z-10 mx-auto mt-6 w-full max-w-6xl shrink-0 px-4 pt-6 md:mt-8 md:pt-8">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Move your mouse — a physics-driven ribbon trails the
                    pointer.
                  </p>
                </div>
                <PenCursor
        ...
        <div className="relative z-10 mt-24 flex min-h-0 w-full flex-1 flex-col self-stretch md:mt-32">
          {/* One column width — matches hero `max-w-6xl` so edges line up */}
          <div className="mx-auto w-full max-w-6xl shrink-0 px-4 pb-10 md:pb-12">
            <motion.section
              initial="hidden"
              whileInView="visible"
            ...
            <section className="mt-20 md:mt-24">
              ...
              >
                ...
                >
                  ...
                  engineers deciding how to spend the afternoon.
                </p>
              </motion.div>
              <div
                className={cn(
              ...
              >
                <table className="w-full min-w-[520px] text-left text-sm">
                  ...
                  <tbody
                    className={
                      isDark
                        ? "divide-neutral-800 divide-y"
                        : "divide-neutral-200 divide-y"
                    }
                  >
                    {[
                      [
                        "Time to first spring hero",
                        "Days–weeks",
                        "Hours + lock-in",
                        "Minutes",
                      ],
            ...
            <section className="mt-20 md:mt-28">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <SpotlightCard
                  theme={theme}
                  className="min-h-56 flex flex-col justify-center rounded-xl p-8 text-center md:min-h-64"
                >
                  <h3
                    className={cn(
            ...
            <footer className="mt-20 border-t pt-10 pb-0 md:mt-24">
              <div className="grid gap-10 md:grid-cols-[1.1fr_minmax(0,1fr)] md:gap-16">
                <div>
                  ...
                  >
                    Copy-paste React components with motion.dev craftsmanship —
                    no theme runtime between you and the DOM.
                  </p>
                  <p
                    className={cn(
                    ...
                    <a
                      ...
                      className={cn(
                        ...
                        isDark
                          ...
                          : "text-neutral-900 hover:text-violet-700",
                      )}
                    >
                      Prashant
                    </a>
                  ...
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <pre
                      className={cn(
                        ...
                        isDark
                          ? "border-neutral-800 bg-black/50 text-neutral-300"
