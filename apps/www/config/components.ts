...
// Source of truth: `registry/components/*.json`.
...
const componentDefinitions = [
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "\"light\" | \"dark\"",
        "default": "\"dark\"",
        "description": "Color theme for the card surface and border."
      }
    ],
    ...
    "props": [
      {
        ...
        "description": "Array of tab configs. Each item has an id (used for layout animation and onChange), a label rendered on the button, and optional content shown when that tab is selected."
      },
      {
        "name": "className",
        "type": "string",
        "description": "Tailwind classes merged onto the outer tabs container."
      },
      {
        "name": "tabClassName",
        "type": "string",
        "description": "Classes applied to each tab button."
      },
      {
        "name": "activeTabClassName",
        "type": "string",
        "description": "Additional classes applied to the currently active tab button."
      },
      {
        "name": "contentClassName",
        "type": "string",
        "description": "Classes applied to the content wrapper rendered below the tab bar."
      },
      {
        "name": "onChange",
        "type": "(id: string) => void",
        "description": "Called when the active tab changes, receiving the newly selected tab id."
      },
      {
        "name": "theme",
        "type": "\"light\" | \"dark\"",
        "default": "\"dark\"",
        "description": "Color theme for the tab bar and content surfaces."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "number",
        "default": "0.1",
        "description": "ScrollRevealGroup only: delay in seconds between each child's staggered reveal."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "\"light\" | \"dark\"",
        "default": "\"dark\"",
        "description": "Color theme for the placeholder surface and shimmer."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        "name": "onClick",
        "type": "() => void",
        "description": "MorphingModalTrigger only: fired when the trigger is clicked — typically used to open the modal."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"white\"",
        "description": "CSS color string for the meteor heads and light trails."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      {
        "name": "items",
        "type": "{ id: string; icon: React.ReactNode; label: string; onClick?: () => void; href?: string }[]",
        "description": "Dock entries. Each item has an id, an icon, a tooltip label, and an optional onClick handler or href (rendered as a link when set)."
      },
      {
        "name": "className",
        "type": "string",
        "description": "Tailwind classes merged onto the dock container."
      },
      {
        "name": "iconSize",
        "type": "number",
        "default": "40",
        "description": "Base size in pixels of each dock icon at rest."
      },
      {
        "name": "maxScale",
        "type": "number",
        "default": "1.8",
        "description": "Maximum scale multiplier applied to the icon nearest the cursor."
      },
      {
        "name": "magneticRange",
        "type": "number",
        "default": "140",
        "description": "Distance in pixels over which the cursor magnifies nearby icons."
      },
      {
        "name": "theme",
        "type": "\"light\" | \"dark\"",
        "default": "\"dark\"",
        "description": "Color theme for the dock surface and tooltips."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        "name": "ariaLabel",
        "type": "string",
        "description": "Accessible label applied to the drawer's dialog region."
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "Called when the active item changes, receiving the newly selected item index."
      }
    ],
    "variants": [
      {
  ...
  },
  {
    ...
    "props": [
      {
        "name": "data",
        "type": "T[]",
        "description": "Typed row objects; the component is generic over your row type."
      },
      {
        "name": "columns",
        "type": "DataTableColumn<T>[]",
        "description": "Column definitions: id, header, accessor (raw value for sort/search/group), optional cell renderer, sortType, searchable, width, align, freeze, nested columns (column groups), and rowSpan. Set freeze: \"left\" or \"right\" on any number of leaf columns, or on a group to inherit it. Width is a preferred minimum; offsets use rendered widths. Keep frozen columns at their corresponding outer edges and leave enough viewport space for both sets."
      },
      {
        "name": "getRowId",
        "type": "(row: T) => string",
        "description": "Required stable row id — selection, expansion, pinning, and windowing keys all hang off it."
      },
      {
        "name": "preset",
        "type": "\"basic\" | \"advanced\" | \"enterprise\"",
        "description": "Feature bundle. basic: search + pagination + sort. advanced: adds multi-sort, multi-select, expansion, sticky header. enterprise: advanced minus pagination so large data auto-virtualizes. Any explicit prop overrides the preset."
      },
      {
        "name": "searchable",
        "type": "boolean",
        "default": "false",
        "description": "Global debounced (150ms) case-insensitive search over searchable columns' accessor values."
      },
      {
        "name": "paginated",
        "type": "boolean",
        "default": "false",
        "description": "Client-side pagination; disables virtualization."
      },
      {
        "name": "pageSize",
        "type": "number",
      ...
      },
      {
        ...
        "type": "number[]",
        "description": "Optional page-size selector values."
      },
      {
        "name": "sortable",
        "type": "boolean",
        "default": "false",
        "description": "Header click cycles asc, desc, none. Typed comparators (number/date/string) inferred from accessor values or set per column via sortType."
      },
      {
        "name": "multiSort",
        "type": "boolean",
        "default": "false",
        "description": "Shift-click adds secondary/tertiary sort keys with visible priority badges."
      },
      {
        "name": "onSort",
        "type": "(sort: DataTableSortRule[]) => void",
        "description": "Called with the full ordered rule list whenever sorting changes."
      },
      {
        "name": "selectable",
        "type": "boolean",
        "default": "false",
        "description": "Checkbox column; the tri-state header checkbox selects all filtered rows, not just the visible page or window."
      },
      {
        "name": "selectedIds",
        "type": "string[]",
      ...
      },
      {
        ...
        "description": "Selection change callback (fires in both controlled and uncontrolled modes)."
      },
      {
        "name": "expandable",
        "type": "boolean",
        "default": "false",
        "description": "Chevron toggle column; requires renderExpanded."
      },
      {
        "name": "renderExpanded",
        "type": "(row: T) => React.ReactNode",
        "description": "Expanded panel content; works in both engines (the virtualizer measures expanded height)."
      },
      {
        "name": "expandedIds",
        "type": "string[]",
        "description": "Controlled expansion; omit for uncontrolled."
      },
      {
      ...
      },
      {
        "name": "groupBy",
        "type": "string",
        "description": "Column id to group rows by — collapsible group header rows; uses the standard engine."
      },
      {
        "name": "virtualized",
        "type": "boolean",
        "description": "Force an engine. Default is automatic: virtualized when flat data exceeds virtualizeThreshold and no groupBy/rowSpan/pagination is active."
      },
      {
        "name": "virtualizeThreshold",
        "type": "number",
        "default": "100",
        "description": "Row count above which flat data is windowed."
      },
      {
        "name": "rowHeight",
        "type": "number",
        "default": "44",
        "description": "Estimated row height in px used for windowing math."
      },
      {
        "name": "maxHeight",
        "type": "number | string",
        "description": "Scroll container height; the virtualized engine falls back to 480px when omitted."
      },
      {
        "name": "stickyHeader",
        "type": "boolean",
        "default": "false",
        "description": "Keep the header row(s) fixed while scrolling vertically."
      },
      {
        "name": "pinnedRows",
        "type": "string[]",
        "description": "Row ids kept visible directly below the header."
      },
      {
        "name": "theme",
        "type": "\"light\" | \"dark\"",
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Show table and cell borders."
      },
      {
    ...
    "variants": [
      ...
      {
        "id": "virtualized",
        "label": "Virtualized 10k rows",
        "demoKey": "data-table/virtualized",
        "overflowVisible": true,
      ...
      {
        "id": "grouped",
        "label": "Grouped rows + rowspan",
        "demoKey": "data-table/grouped",
        "overflowVisible": true,
      ...
      {
        "id": "column-groups",
        "label": "Column groups + freeze",
        "demoKey": "data-table/column-groups",
        "overflowVisible": true,
      ...
      {
        "id": "freeze-multiple-left",
        "label": "Freeze multiple left columns",
        "demoKey": "data-table/freeze-multiple-left",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 24 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Scroll horizontally to keep frozen columns in view.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        sortable\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150, freeze: \"left\" },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140, freeze: \"left\" },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130 },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130 }\n      ]}\n      />\n    </div>\n  );\n}"
      },
      {
        "id": "freeze-multiple-right",
        "label": "Freeze multiple right columns",
        "demoKey": "data-table/freeze-multiple-right",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 24 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Scroll horizontally to keep frozen columns in view.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        sortable\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150 },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140 },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130, freeze: \"right\" },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130, freeze: \"right\" }\n      ]}\n      />\n    </div>\n  );\n}"
      },
      {
        "id": "freeze-both",
        "label": "Freeze multiple columns on both edges",
        "demoKey": "data-table/freeze-both",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 24 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Scroll horizontally to keep frozen columns in view.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        sortable selectable expandable renderExpanded={(row: Row) => <div>Details for {row.name}</div>}\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150, freeze: \"left\" },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140, freeze: \"left\" },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130, freeze: \"right\" },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130, freeze: \"right\" }\n      ]}\n      />\n    </div>\n  );\n}"
      },
      {
        "id": "freeze-virtualized",
        "label": "Virtualized rows + frozen columns",
        "demoKey": "data-table/freeze-virtualized",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 1000 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Scroll horizontally to keep frozen columns in view.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        preset=\"enterprise\"\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150, freeze: \"left\" },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140, freeze: \"left\" },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130, freeze: \"right\" },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130, freeze: \"right\" }\n      ]}\n      />\n    </div>\n  );\n}"
      },
      {
        "id": "freeze-groups",
        "label": "Frozen column groups",
        "demoKey": "data-table/freeze-groups",
        "overflowVisible": true,
      ...
      {
        "id": "pinned-rows",
        "label": "Pinned rows + frozen columns",
        "demoKey": "data-table/pinned-rows",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 24 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Pinned rows + frozen columns.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        sortable pinnedRows={[\"account-0\", \"account-1\"]}\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150, freeze: \"left\" },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140 },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130 },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130, freeze: \"right\" }\n      ]}\n      />\n    </div>\n  );\n}"
      },
      {
        "id": "controlled",
        "label": "Controlled selection + expansion",
        "demoKey": "data-table/controlled",
        "overflowVisible": true,
      ...
      },
      {
        "id": "empty",
        "label": "Empty table",
        "demoKey": "data-table/empty",
        "overflowVisible": true,
        "usageCode": "\"use client\";\nimport { DataTable } from \"@/components/ui/data-table\";\n\nexport default function Example() {\n  const rows = Array.from({ length: 0 }, (_, i) => ({\n    id: `account-${i}`,\n    name: [\"Alex Kim\", \"Sara Chen\", \"Jordan Lee\", \"Maya Patel\"][i % 4],\n    team: [\"Platform\", \"Product\"][i % 2],\n    email: `member${i}@example.com`,\n    region: [\"North America\", \"Europe\", \"Asia Pacific\"][i % 3],\n    revenue: (i + 1) * 129.5,\n    status: i % 3 === 0 ? \"Pending\" : \"Active\",\n    actions: \"Review\",\n  }));\n  type Row = (typeof rows)[number];\n  return (\n    <div className=\"min-w-0 w-full p-6\">\n      <p className=\"mb-3 text-sm text-neutral-500\">Empty table.</p>\n      <DataTable data={rows} getRowId={(row: Row) => row.id}\n        sortable\n        stickyHeader maxHeight={320} border theme=\"dark\"\n        columns={[\n        { id: \"name\", header: \"Name\", accessor: (row: Row) => row.name, width: 150 },\n        { id: \"team\", header: \"Team\", accessor: (row: Row) => row.team, width: 140 },\n        { id: \"email\", header: \"Email\", accessor: (row: Row) => row.email, width: 250 },\n        { id: \"region\", header: \"Region\", accessor: (row: Row) => row.region, width: 180 },\n        { id: \"revenue\", header: \"Revenue\", accessor: (row: Row) => row.revenue, width: 140, align: \"right\", cell: (row: Row) => `$${row.revenue.toFixed(2)}` },\n        { id: \"status\", header: \"Status\", accessor: (row: Row) => row.status, width: 130 },\n        { id: \"actions\", header: \"Actions\", accessor: (row: Row) => row.actions, width: 130 }\n      ]}\n      />\n    </div>\n  );\n}"
      }
    ],
    "usageCode": "\"use client\";\nimport { DataTable, type DataTableColumn } from \"@/components/ui/data-table\";\n\ninterface Person {\n  id: string;\n  name: string;\n  role: string;\n  score: number;\n}\n\nconst data: Person[] = [\n  { id: \"1\", name: \"Alice Chen\", role: \"Engineer\", score: 92 },\n  { id: \"2\", name: \"Bob Martin\", role: \"Designer\", score: 78 },\n  { id: \"3\", name: \"Carol White\", role: \"Product\", score: 85 },\n  { id: \"4\", name: \"Dan Brown\", role: \"Engineer\", score: 88 },\n  { id: \"5\", name: \"Eve Davis\", role: \"Marketing\", score: 73 },\n];\n\nconst columns: DataTableColumn<Person>[] = [\n  { id: \"name\", header: \"Name\", accessor: (row) => row.name },\n  { id: \"role\", header: \"Role\", accessor: (row) => row.role },\n  { id: \"score\", header: \"Score\", accessor: (row) => row.score, align: \"right\" },\n];\n\nexport default function Example() {\n  return (\n    <div className=\"p-6\">\n      <DataTable data={data} columns={columns} getRowId={(row) => row.id} preset=\"basic\" pageSize={3} theme=\"dark\" />\n    </div>\n  );\n}"
  },
  {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"var(--color-neutral-300, #d4d4d4)\"",
    ...
    "props": [
      {
        ...
        "type": "\"light\" | \"dark\"",
        "default": "\"dark\"",
        "description": "Palette for the field, scrim, text, and CTAs. Forwarded to the background and default content."
      },
      {
        "name": "children",
        "type": "ReactNode",
        "description": "Slotted hero content. Omit for the default theme-aware headline + CTAs."
      },
      {
        "name": "className",
        "type": "string",
      ...
      {
        "name": "backgroundProps",
        "type": "{ theme?: \"light\" | \"dark\"; colors?: [string, string]; density?: number; lineWidth?: number; scrollStrength?: number; speed?: number; trail?: number; className?: string }",
