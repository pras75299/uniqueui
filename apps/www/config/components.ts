    ...
    <ScrollReveal>
      Content goes here
                  ...
                  },
                  {
                        "name": "duration",
                        "type": "number",
                        "description": "Length of the reveal animation."
                  },
                  {
                        "name": "threshold",
                        "type": "number",
...
export default function Example() {
  return (
    <div className="flex flex-col items-center justify-start h-[400px] w-full overflow-y-auto p-10 relative rounded-xl border border-neutral-800 text-white">
    ...
    <MorphingModal>
      Content goes here
    ...
    } },
                  {
                        "name": "onClose",
                        "type": "() => void",
                        "description": "Callback functionality to trigger the exit modal sequence."
                  },
                  {
                        "name": "children",
                        "type": "React.ReactNode",
                  ...
                  },
                  {
                        "name": "overlayClassName",
                        "type": "string",
                        "description": "Styling overrides for the full-screen backdrop overlay layer."
                  },
                  {
                        "name": "layoutId",
                        "type": "string",
